    ...
    SuperRareBazaarBase
{
    ...
    function configureAuction(
        ...
        tokenAuctions[_originContract][_tokenId] = Auction(
           payable(msg.sender),
            block.number,
            _auctionType == COLDIE_AUCTION ? 0 : _startTime,//change this conditon as custemer need 
            _lengthOfAuction,
            _currencyAddress,
            _startingAmount,
            _auctionType,
    ...
    function bid(
        ...
        require(
            block.timestamp >= auction.startingTime,//bid ka time
        ...
        require(
            auction.startingTime == 0 ||
                block.timestamp <
                auction.startingTime.add(auction.lengthOfAuction),//bid ka time
            "bid::Must be active."
        );
